...
| :no_entry_sign: No | >1 GB | Unstructured, text-based | Any | Global or local-level reasoning | Consider generic search tools to curate smaller datasets for the Bookshelf | N/A | Identifying project-specific, KB-sized datasets from all company IP |
